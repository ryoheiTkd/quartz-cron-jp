...
| Cron式 | 日本語 | 説明 |
|--------|--------|------|
| `0 0 12 * * ?` | 毎日午後12時00分 | 毎日正午 |
| `0 30 9 ? * MON-FRI` | 毎週平日（月〜金） 午前9時30分 | 平日の朝 |
| `0 0 0 1 * ?` | 毎月1日 午前0時00分 | 月初め |
| `0 0 0 1 1 ? 2025` | 2025年1月1日 午前0時00分 | 特定日時 |
...
| `0 0/30 9-17 ? * MON-FRI` | 平日午前9時〜午後5時の間、0分起点で30分間隔 | 業務時間中30分間隔 |
| `0/10 * * * * ?` | 0秒起点で10秒間隔 | 10秒間隔 |
| `0 0 0/2 * * ?` | 毎日午前0時00分起点で2時間間隔 | 0:00, 2:00, 4:00... |
...
| `0 0 9-17 ? * MON-FRI` | 毎週平日（月〜金） 午前9時〜午後5時の間、毎時00分 | 業務時間毎時 |
| `0 0 9 1,15 * ?` | 毎月1、15日 午前9時00分 | 月2回 |

### 特殊記号（L, W, #）

| Cron式 | 日本語 | 説明 |
|--------|--------|------|
| `0 0 18 L * ?` | 毎月末日 午後6時00分 | 月末処理 |
| `0 0 9 15W * ?` | 毎月15日に最も近い平日 午前9時00分 | 15日が休日なら前後の平日 |
| `0 0 10 ? * MON#1` | 毎月第1月曜日 午前10時00分 | 第1月曜 |
| `0 0 10 ? * FRI#3` | 毎月第3金曜日 午前10時00分 | 第3金曜 |
