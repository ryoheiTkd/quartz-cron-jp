...
| `0 0 0/2 * * ?` | 毎日午前0時起点で2時間間隔 | 0:00, 2:00, 4:00... |
...
| `0 0 9-17 ? * MON-FRI` | 毎週平日（月〜金） 午前9時〜午後5時 | 業務時間毎時 |
...
終了値が開始値より小さい範囲指定に対応しています。

| Cron式 | 日本語 | 説明 |
|--------|--------|------|
| `0 0 22-5 * * ?` | 毎日午後10時〜午前5時 | 深夜帯 |
| `0 0 9 ? * FRI-MON` | 毎週金〜月曜日 午前9時 | 週末＋月曜 |
| `0 0 9 1 NOV-FEB ?` | 毎年11月〜2月1日 午前9時 | 冬季（年跨ぎ） |
| `0 0 9 25-5 * ?` | 毎月25〜5日 午前9時 | 月末〜月初 |
| `0 0 22-5/2 ? * FRI-MON` | 毎週金〜月曜日 午後10時〜午前5時の間、2時間間隔 | 跨ぎ＋間隔 |
